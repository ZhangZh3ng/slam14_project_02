/*
 * @Author: your name
 * @Date: 2021-02-17 16:24:28
 * @LastEditTime: 2021-02-19 10:03:27
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /ch9/test/run_vo.cpp
 */
...
int main(int argc, char **argv)
{
    ...
    cout << "dataset_dir is: " << dataset_dir << endl;
    ...
    while (!fin.eof())
    {
        string rgb_time, rgbfile, depth_time, depth_file;
        fin >> rgb_time >> rgbfile >> depth_time >> depth_file;

        rgb_times.push_back(atof(rgb_time.c_str()));
        depth_times.push_back(atof(depth_time.c_str()));
        rgb_files.push_back(dataset_dir + "/" + rgbfile);
