/*
 * @Author: your name
 * @Date: 2021-02-17 17:40:33
 * @LastEditTime: 2021-02-18 21:23:07
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /ch9/src/visual_odometry.cpp
 */
...
namespace myslam
{
    ...
    void VisualOdometry::featureMatching()
    {
        ...
        matcher.match(descriptros_ref_, descriptors_curr_, matches);
    ...
    void VisualOdometry::setRef3DPoints()
    {
        ...
        for(size_t i=0; i < keypoints_curr_.size(); i++)
        {
            ...
            if(d > 0)
            {
                ...
                descriptros_ref_.push_back(descriptors_curr_.row(i));
            }
        }
    }
    ...
    void VisualOdometry::poseEstimationPnP()
    {
        ...
        /** 因为SO3实例不能直接用三个标量来生成，因此对下面进行了修改*/
        Sophus::Vector3d rotation_vector(rvec.at<double>(0, 0), rvec.at<double>(1, 0),rvec.at<double>(2, 0)); // 从rvec中提取rotation vector
